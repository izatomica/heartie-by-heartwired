...
export function ActivityCard({ activity, onClick }: ActivityCardProps) {
  ...
  const statusConfig = {
    ...
    in_progress: { bg: 'var(--color-warning-light)', text: 'var(--color-warning)', dot: '●' },
    scheduled: { bg: 'var(--color-success-light)', text: 'var(--color-success)', dot: '●' },
    running: { bg: '#E8E9FE', text: '#6366F1', dot: '▶' },
    done: { bg: '#E8D5C4', text: '#8B6914', dot: '✓' },
  };
