          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-text-primary">Platform</th>
                <th className="text-left py-3 px-4 text-sm font-semibold text-text-primary">Stage</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-text-primary">Engagement</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-text-primary">Reach</th>
                <th className="text-right py-3 px-4 text-sm font-semibold text-text-primary">Conversions</th>
              </tr>
            </thead>
            <tbody>
              {CONTENT_PERFORMANCE.map((content) => {
                ...
                return (
                  <tr key={content.id} className="border-b border-border hover:bg-cream-dark transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className="text-sm">{platformInfo.icon} {platformInfo.name}</span>
                    </td>
                    <td className="py-3 px-4">
                      <span
                    ...
                    <td className="py-3 px-4 text-right text-sm text-text-primary">{content.engagement}</td>
                    <td className="py-3 px-4 text-right text-sm text-text-primary">{content.reach}</td>
